const lesson1 = {
    ...
    tasks: [
        ...
        { id: 4, direction: "PL → FR", prompt: "Mówimy trochę po francusku.", answers: ["nous parlons un peu francais", "on parle un peu francais"], note: "Po <em>parler</em> bez rodzajnika: <em>parler français</em>. «On» = potoczne «nous»." },
        {
            ...
            canonMap: {
                "tu aimes le cafe": "Tu aimes le café ?",
                "est ce que tu aimes le cafe": "Est-ce que tu aimes le café ?",
                "aimes tu le cafe": "Aimes-tu le café ?"
            },
            note: "Trzy wzorce pytania: intonacja / est‑ce que / inwersja."
    ...
    vocab: [
        ...
        { fr: "chat", pl: "kot", pos: "rzecz.", gender: "m", ipa: "ʃa" },
        { fr: "maison", pl: "dom", pos: "rzecz.", gender: "f", ipa: "mɛzɔ̃" },
        ...
        { fr: "français", pl: "francuski (język)", pos: "rzecz./przym.", gender: "m", ipa: "fʁɑ̃sɛ" },
        { fr: "aimer", pl: "lubić", pos: "czas.", ipa: "eme" },
        { fr: "café", pl: "kawa", pos: "rzecz.", gender: "m", ipa: "kafe" },
        { fr: "ce", pl: "to", pos: "zaimek", ipa: "sə" },
        { fr: "facile", pl: "łatwy", pos: "przym.", ipa: "fasil" },
        { fr: "où", pl: "gdzie", pos: "przysł.", ipa: "u" },
        { fr: "gare", pl: "dworzec", pos: "rzecz.", gender: "f", ipa: "ɡaʁ" },
        { fr: "je voudrais", pl: "chciałbym / chciałabym", pos: "zwrot", ipa: "ʒə vudʁɛ" },
        { fr: "de l'eau", pl: "(trochę) wody", pos: "wyraż.", gender: "f", ipa: "də lo" },
